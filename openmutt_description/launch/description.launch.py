...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="openmutt_description").find("openmutt_description")
    default_model_path = os.path.join(pkg_share, "urdf/openMuttSensors.urdf")
