...
def generate_launch_description():
    ...
    config_pkg_share = launch_ros.substitutions.FindPackageShare().find("champ_config")
    descr_pkg_share = launch_ros.substitutions.FindPackageShare().find("champ_description")
